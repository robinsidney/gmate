...
3. And run install script:
   ...
   **Note:** Some commands will expect you enter your sudo password. Fedora 18 has gedit/plugins in /usr/lib64. updated install file. Also disregard scriplet outputs for they are developer-oriented warning messages from glib-compile-schemas. Enjoy!! :-)
